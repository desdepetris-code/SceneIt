...
import { TmdbMedia, TrackedItem, Reminder, ReminderType } from '../types';
...
const UpcomingPremieresCarousel: React.FC<UpcomingPremieresCarouselProps> = (props) => {
    const { title, onSelectShow, onOpenAddToListModal, onMarkShowAsWatched, completed, reminders, onToggleReminder, onViewMore } = props;
